...
class FilterRow(object):
    ...
    def __init__(self, option, change_list, data_list, param_dict=None, is_choice=None):
        self.option = option
        ...
        for option in self.model_config.list_filter:
            ...
            if option.is_func:
                ...
                if isinstance(_field, ForeignKey):
                    ...
                    data_list = FilterRow(option, self, _field.choices, self.model_config.request.GET, is_choice=True)
            yield data_list
...
class AryaConfig(object):
    ...
    def changelist_view(self, request, *args, **kwargs):
        ...
        data_list = self.model_class.objects.filter(**self.get_list_filter_condition).filter(self.get_search_condition)
